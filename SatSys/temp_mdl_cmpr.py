...
for age in range(2):
    for tst in range(3):
        ...
        sim_0w = sat_sim(dat, T_ord=0, T_parts=sh.T_wide)
        sim_0n = sat_sim(dat, T_ord=0, T_parts=sh.T_narrow)
        sim_0hl = sat_sim(dat, T_ord=0, T_parts=sh.T_hl)
        ...
        sim_1hl = sat_sim(dat, T_ord=1, T_parts=sh.T_hl)
        sim_2 = sat_sim(dat , T_ord=2, T_parts=sh.T_none)
        sim_2w = sat_sim(dat, T_ord=2, T_parts=sh.T_wide)
        sim_2hl = sat_sim(dat, T_ord=2, T_parts=sh.T_hl)
